...
export default function Slider1({
  ...
  useEffect(() => {
    if (swiperRef.current && items[activeIndex].color !== activeColor) {
      const slideIndex =
        items.findIndex((elm) => elm.color === activeColor);
    ...
    <>
      ...
      <div className="flat-wrap-media-product">
        <Swiper
          ...
          // ✅ Fix 2: thumbs expects Swiper | null
          thumbs={{ swiper: thumbSwiper }}
          navigation={{
            prevEl: ".snbp1",
            nextEl: ".snbn1",
          }}
          // ✅ Fix 3: proper type for swiperRef
